...
OnChildClickListener, OnGroupClickListener {
  ...
  private void startChannelQuery(final boolean useCache) {
    ...
    final ChannelClient channelClient = new ChannelClient(getCertificateProblemDialog());
  ...
  public boolean onOptionsItemSelected(
    ...
    case R.id.channels_recent_channels:
      ...
      .setAdapter(getRecentAdapter(),
        ...
        public void onClick(final DialogInterface dialog,
            final int which) {
          final Channel c = recentAdapter.getItem(which);
          startChannelEPG(c);
        }
      })//
      .create().show();
  ...
  @Override
  public boolean onGroupClick(final ExpandableListView arg0, final View arg1, final int arg2,
      final long arg3) {
    return true;
  }
